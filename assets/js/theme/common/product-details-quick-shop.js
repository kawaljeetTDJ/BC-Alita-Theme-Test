...
export default class ProductDetails {
    constructor($scope, context, productAttributesData = {}) {
        ...
        $form.find('#form-action-addToCart').on('click', event => {
    ...
    setProductVariant() {
        ...
        $.each($('.halo-quickShop [data-product-attribute]'), (index, value) => {
    ...
    showMessageBox(message) {
        const $messageBox = $('.halo-quickShop .productAttributes-message');
